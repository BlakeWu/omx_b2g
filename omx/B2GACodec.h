...
#include <IOMX.h>
#include <stagefright/foundation/AHierarchicalStateMachine.h>
#include <stagefright/SkipCutBuffer.h>
#include <OMX_Audio.h>
...
struct B2GACodec : public AHierarchicalStateMachine {
    enum {
...
private:
    ...
    //Variables for B2GACodec to maintain the usecase and its state.
    String8 mUseCase;
    bool mUseCaseFlag;
    ...
    DISALLOW_EVIL_CONSTRUCTORS(B2GACodec);
};

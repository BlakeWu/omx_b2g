...
#ifndef B2G_MEDIA_CODEC_H_

#define B2G_MEDIA_CODEC_H_
...
struct B2GMediaCodec : public AHandler {
    enum ConfigureFlags {
    ...
    static sp<B2GMediaCodec> CreateByType(
            const sp<ALooper> &looper, const char *mime, bool encoder);

    static sp<B2GMediaCodec> CreateByComponentName(
    ...
    status_t getInputBuffers(Vector<sp<BufferInfo> > *buffers) const;
    status_t getOutputBuffers(Vector<sp<BufferInfo> > *buffers) const;
...
private:
    ...
    B2GMediaCodec(const sp<ALooper> &looper);
    ...
    DISALLOW_EVIL_CONSTRUCTORS(B2GMediaCodec);
};
